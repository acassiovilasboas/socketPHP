...
use App\Model\Loan as ModelLoan;
...
class Loan
{
    ...
    {
        $this->validateTransection->RuleAgencyOfBank($this->model->getAgency());
        $this->validateTransection->RuleAccountOfBank($this->model->getAccount());
